...
class FeatureFlagEvaluatorTest {
  ...
  void tenantIdTakesPriorityOverUserIdForBucketCalculation() {
    ...
    EvaluationResult withFirstUser =
        evaluator.evaluate(flag, context("production", "tenant-a", "user-a"));
    EvaluationResult withSecondUser =
        evaluator.evaluate(flag, context("production", "tenant-a", "user-b"));
    EvaluationResult withTenantOnly =
        evaluator.evaluate(flag, context("production", "tenant-a", null));
  ...
  void userIdIsUsedForBucketCalculationWhenTenantIdIsMissing() {
    ...
    EvaluationResult withSameValueAsTenant =
        evaluator.evaluate(flag, context("production", "user-a", "ignored-user"));
